...
import com.example.map.Model.LocationModel;
import com.example.map.network.ApiClient;
import com.example.map.network.ApiService;
...
//        setContentView(binding.getRoot());
    ...
    private void getAllDataLocation() {
        ...
        call.enqueue(new Callback<ListLocationModel>() {
            ...
            @Override
            public void onFailure(Call<ListLocationModel> call, @NonNull Throwable t) {
             progressDialog.dismiss();
    ...
    private class MakerCallBack implements com.squareup.picasso.Callback{
      Marker marker = null;
      public void MarkerCallBack(Marker marker) {
          this.marker =marker;
      }
          @Override
          public void onSuccess () {
